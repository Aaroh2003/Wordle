...
import { StyleSheet, TouchableOpacity, View, Text, Modal, Image, Alert,Dimensions } from 'react-native';
...
const App = () => {
  ...
  const [foolModalVisible, setFoolModalVisible] = useState(false);
  ...
  return (
    <NativeBaseProvider>
      <View style={styles.container}>
        ...
        animationType="slide"
        transparent={true}
        visible={foolModalVisible}
        onRequestClose={closeModal}
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={[styles.modalHeaderText]}>You Incompetent bitch!</Text>
            <LottieView
              source={require('./components/assets/jon.json')}
              autoPlay
              loop={true}
            ...
            <View style={styles.modalView}>
              <View style={styles.modalHeader}>
                ...
                <TouchableOpacity onPress={() => setInfo(false)}>
                  <EvilIcons name="close" size={25} color="#fff" style={{ alignSelf:'flex-end' }} />
                </TouchableOpacity>
              </View>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Text style={[styles.modalText,{alignSelf:"center"}]}>You won the game in {tries} tries.</Text>
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <LottieView
                ...
                autoPlay
                loop={true}
                style={[styles.lottieAnimation, { alignSelf:"center" }]} // Add this style to adjust the size of the animation
              />
              <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  navbar: {
    ...
    paddingHorizontal: 0.05 * width, // Adjust the paddingHorizontal value
    backgroundColor: '#121213',
    color: '#fff',
  },
  title: {
    color: '#fff',
    marginLeft: 0.3 * width, // Adjust the marginLeft value
  },
  icon: {
    marginLeft: 0.06 * width, // Adjust the marginLeft value
    flexDirection: 'row',
  },
  square: {
    width: `${(100 - 6 * 1) / 5}%`,
    height: 0.1 * height, // Adjust the height value
    borderWidth: 1,
    borderColor: '#FFFFFF',
    marginBottom: 3,
  ...
  gridContainer: {
    ...
    flexWrap: 'wrap',
    justifyContent: 'space-between',
    paddingHorizontal: 0.1 * width, // Adjust the paddingHorizontal value
    marginVertical: 0.025 * height, // Adjust the marginVertical value
  },
